...
#include "mpc_tracking_controller/mpc_plannner.h"
...
MPC::MPC( )
{
    // Set default value    
    _mpc_steps = 20; //20
    _max_angvel =3.0; // Maximal angvel radian (~30 deg) 3.0
    _max_throttle = 10; // Maximal throttle accel 1.0
    _bound_value  = 1.0e3; // Bound value for other variables 1.0e3
//    _fgEval = FG_eval(coff) ;
    _x_start     = 0;
